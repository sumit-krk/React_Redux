...
const Form = ({ handleClose }) => {
  ...
  return (
    <form className={classes.root} onSubmit={handleSubmit}>
      ...
      <TextField label="Last Name" variant="filled" required value={lastName}
        onChange={e => setLastName(e.target.value)}
      />
      <TextField label="Gander (M/F)" variant="filled" required value={ Gender } onChange={e => setGender(e.target.value)}
      />
      ...
      <div>
        ...
        <Button type="submit" variant="contained" color="primary" onClick={Success}>
          Signup
        </Button>
      </div>
    </form>
